...
st.write("Para desbloquear su regalo, tendrá que resolver la integral del día... Solo se aceptan dígitos, comas y el signo negativo (-). La contraseña tiene 6 dígitos (sin contar con la coma decimal y el signo negativo, si es que hay), así que deberá redondear correctamente el resultado.")
